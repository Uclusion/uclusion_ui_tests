import {deleteCognitoUser, prepareWorkspaceAndGroup} from "../../support/fixture_management";
...
describe('Authenticator:', function() {
    ...
    beforeEach(function() {
        ...
        return prepareUsersForTest(3, 'create_job')
            .then((preparedUsers) => {
                users = preparedUsers;
                return prepareWorkspaceAndGroup(destination, 'smoky', 'bandits', users);
            });
    });
